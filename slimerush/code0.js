...
gdjs.Level_321Code.GDChronoObjects1= [];
gdjs.Level_321Code.GDChronoObjects2= [];
...
gdjs.Level_321Code.GDWallPaperObjects1= [];
gdjs.Level_321Code.GDWallPaperObjects2= [];
...
gdjs.Level_321Code.mapOfGDgdjs_9546Level_9595321Code_9546GDSpikeObjects1Objects = Hashtable.newFrom({"Spike": gdjs.Level_321Code.GDSpikeObjects1});
gdjs.Level_321Code.mapOfGDgdjs_9546Level_9595321Code_9546GDPlayerObjects1Objects = Hashtable.newFrom({"Player": gdjs.Level_321Code.GDPlayerObjects1});
gdjs.Level_321Code.mapOfGDgdjs_9546Level_9595321Code_9546GDFlagObjects1Objects = Hashtable.newFrom({"Flag": gdjs.Level_321Code.GDFlagObjects1});
...
{for(var i = 0, len = gdjs.Level_321Code.GDPlayerObjects1.length ;i < len;++i) {
    gdjs.Level_321Code.GDPlayerObjects1[i].getBehavior("Flippable").flipX(true);
}
}}
...
gdjs.copyArray(runtimeScene.getObjects("Player"), gdjs.Level_321Code.GDPlayerObjects1);
{for(var i = 0, len = gdjs.Level_321Code.GDPlayerObjects1.length ;i < len;++i) {
    gdjs.Level_321Code.GDPlayerObjects1[i].getBehavior("Flippable").flipX(false);
}
}}
...
let isConditionTrue_0 = false;
{
gdjs.copyArray(runtimeScene.getObjects("Chrono"), gdjs.Level_321Code.GDChronoObjects1);
{runtimeScene.getScene().getVariables().getFromIndex(0).add(gdjs.evtTools.runtimeScene.getElapsedTimeInSeconds(runtimeScene));
}{for(var i = 0, len = gdjs.Level_321Code.GDChronoObjects1.length ;i < len;++i) {
    gdjs.Level_321Code.GDChronoObjects1[i].getBehavior("Text").setText(gdjs.evtTools.common.toString(Math.floor(gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().getFromIndex(0)) * 100) / 100));
}
}}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.object.hitBoxesCollisionTest(gdjs.Level_321Code.mapOfGDgdjs_9546Level_9595321Code_9546GDPlayerObjects1Objects, gdjs.Level_321Code.mapOfGDgdjs_9546Level_9595321Code_9546GDSpikeObjects1Objects, false, runtimeScene, false);
if (isConditionTrue_0) {
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.object.hitBoxesCollisionTest(gdjs.Level_321Code.mapOfGDgdjs_9546Level_9595321Code_9546GDPlayerObjects1Objects, gdjs.Level_321Code.mapOfGDgdjs_9546Level_9595321Code_9546GDFlagObjects1Objects, false, runtimeScene, false);
if (isConditionTrue_0) {
...
gdjs.Level_321Code.GDChronoObjects1.length = 0;
gdjs.Level_321Code.GDChronoObjects2.length = 0;
...
gdjs.Level_321Code.GDWallPaperObjects1.length = 0;
gdjs.Level_321Code.GDWallPaperObjects2.length = 0;
